...
let subjOps = (subjects, topics, questions) => {
    ...
    subjects.forEach((subj, index) => {
        ...
        $('.getTopics').on('click', function(e){
            ...
            // called function for getting subjects' topics
            getSubjTopics(subjId, subjName, topics, questions)
...
function getSubjTopics(subjId, subjName, topics, questions){
    ...
    getTopicsQuestions(questions, subjName);
}

function getTopicsQuestions(questions, subjName){
    $('.getQues').on('click', function(e){
        ...
        operations(quesLen, thisTopicsQuestions);
    });
}

function operations(quesLen, thisTopicsQuestions){
    $('#homeQues').removeClass('hide');
        ...
        $('#submit').on('click', function(e){
            ...
            let report = '<h3 class="white-text center-align">Your score is '+percent+'%</h3>';
            
            $('#resultModal').append(report);
